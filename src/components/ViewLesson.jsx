  ...
  return (
    <div>
      ...
      <div className="flex justify-center gap-4">
        <p className="p-2 rounded-md font-bold bg-green-200 text-xs">Easy</p>
        <p className="p-2 rounded-md font-bold bg-yellow-200 text-xs">Medium</p>
        <p className="p-2 rounded-md font-bold bg-red-200 text-xs">Hard</p>
      </div>
